...
function App() {
  ...
  const [rphrase,setRphrase] = React.useState('το σπίτι μου είναι καθαρό')
  /*
...
const phrase = convert()
  
const handleKeyDown = function(e) {
  if (e.key === 'Enter') {
    setRphrase(e.target.value)
  }
}
  ...
  return (
    <div id="greekconvert">
    <h1 id='text' >{phrase}</h1>
    <input id='input' onKeyDown={handleKeyDown} placeholder="paste your greek text here" />
    </div>
  );
}
